$( document ).ready(function() {
    ...
    var result_url = jQuery.parseJSON(url_result);
	var url = result_url[0].pdf_path;

	 //    var magazine_url=null;
	...
	var kDefaultURL = url;
	//var kDefaultURL = '/uploads/magazine/file/11/11_Yojana January 2012.pdf';
	...
	var PDFView = {
	  ...
	  //zoom in or zoom out start here
	  ...
	  //function for loading bar animation
	  ...
	  //create the thumbnails for the sidebar
	...
	var PageView = function pageView(container, pdfPage, id, scale,
	  ...
	  //get the defalult scale or take the defined value
	  this.scale = scale || .95;
	  ...
	  function setupAnnotations(pdfPage, viewport) {
	    ...
	    //create the width of the current element
	...
	//enable or disable the text layer
    ...
    //     return largeMagazineWidth()/$('#viewer').width();
    ...
    //       $('.made').hide();
    //       $('#viewer').removeClass('animated').addClass('zoom-in');
	...
	$('#viewer').click(function(e) {
	 ...
	 //    $(".magazine-viewport").zoom({
		...
		// 	flipbook: $("#viewer"),
		// 	max: function() {
		// 		return 2000/$('.magazine-viewport').width();
		// 	}
		// });
	});
